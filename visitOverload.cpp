...
overloaded carElementPrintVisitor {
    ...
    [](this auto const& self, const Car& car)  {  car.visitCarElements(self);  std::cout << "Visiting car" << '\n'; },
...
overloaded carElementDoVisitor {
    ...
    [](this auto const& self, const Car& car) {  car.visitCarElements(self);  std::cout << "Starting my car" << '\n'; },
